...
export default function Education() {
  return (
    <section className="education-section alternat-2 p_relative">
      ...
      <div className="bg-layer parallax-bg" data-parallax='{"y": 100}' style={{ backgroundImage: 'url(assets/images/icons/us.jpg)' }}></div>
      ...
      <div className="shape">
        <div className="shape-2" style={{ backgroundImage: 'url(assets/images/icons/us.jpg)' }}></div>
      </div>
        ...
        <div className="content_block_three">
          <div className="content-box p_relative d_block">
            ...
            <ul className="country-list">
              <li>
                <div className="flag"><img src="assets/images/icons/flag56.png" alt="" width={50} height={50} /></div>
